...
a persistence unit "Prueba_AlvaradoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Prueba_Alvarado/pom.xml":
...
artifact ("Prueba_Alvarado.war") is already built. You can build
